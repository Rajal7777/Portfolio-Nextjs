  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-4xl px-4 py-8 text-slate-800 dark:text-slate-200 antialiased font-sans">
        <FadeIn delay={0.1}>
          <h2 className="mb-8 text-2xl md:text-4xl text-slate-800 bg-slate-100 dark:bg-slate-900 py-2 font-semibold playfair text-center border border-gray-200 dark:border-gray-700 rounded-sm dark:text-slate-100">
            {t("visaQualification")}
          </h2>

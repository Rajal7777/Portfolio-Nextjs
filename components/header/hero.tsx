...
const HeroSection = async () => {
    ...
    return (
        <section className="mx-auto flex min-h-[calc(100svh-5rem)] max-w-6xl flex-col gap-8 px-4 py-10 sm:px-6 md:gap-10 md:py-14 lg:flex-row lg:items-center lg:justify-between">
            <main className="order-2 max-w-2xl space-y-5 text-center lg:order-1 lg:text-left">
                ...
                <div className="flex flex-col items-center justify-center gap-3 sm:flex-row lg:justify-start">
                    <a
                        href="/CV/resume.pdf"
                        download="resume.pdf"
                        className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-gray-600 px-5 py-1 text-sm font-medium text-background transition-colors hover:bg-gray-700/90 hover:text-muted-foreground sm:w-auto md:py-3"
                    >
                        {t("resumeCta")}
